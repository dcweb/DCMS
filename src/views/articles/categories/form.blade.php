...
@section("content")
    ...
    <div class="main-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{ URL::to('admin/articles/categories') }}"><i class="fa fa-pencil"></i> Categories</a></li>
				@if(isset($category))
    	...
    	<div class="row">
            ...
            @if(isset($category))
              <h2>Edit category</h2>
                ...
                {{ Form::model($category, array('route' => array('admin.articles.categories.update', $category->id), 'method' => 'PUT')) }}
            @else
              <h2>Create category</h2>
              
                {{ Form::open(array('url' => 'admin/articles/categories')) }}
            @endif
            ...
            @foreach($languages as $lang)
              ...
              <?php
                  ...
                  $divTabContent .= Form::hidden('article_category_id['.$lang->language_id.']', $lang->id);
